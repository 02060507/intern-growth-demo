export const interns = [
  ...
  },
  {
    ...
    blocker: '近几日缺少关键任务更新，进入节奏偏慢。',
    summary: '基础能力具备，但当前任务承接不足，建议本周增加跟进频次。'
  },
  {
    id: 5,
    name: '沈知',
...
export const mentorAlerts = [
  '顾然近几日缺少关键任务更新，建议本周安排一次短会确认承接情况。',
  '周岚已完成基础观察期，可安排一个独立子任务进一步验证方案能力。',
  '许诺当前状态稳定，建议尝试承担更完整的客户跟进链路。'
];
...
export const stageAdvice = {
  '研发实习生': '当前建议先完成业务链路与代码模块的对应理解，再逐步承接低风险需求，并沉淀自己的开发与联调清单。',
  '产品实习生': '当前阶段应重点提升结构化分析与需求表达能力，建议先围绕目标、用户、流程、指标四个维度完善需求草案。',
  '销售实习生': '当前可逐步进入独立练习阶段，建议围绕客户异议、产品卖点和案例表达进行集中训练，并形成复盘记录。'
};